package net.it_adviser.gps.pgsd4java.backend;
...
import net.it_adviser.gps.pgsd4java.types.ATTObject;
import net.it_adviser.gps.pgsd4java.types.DeviceObject;
import net.it_adviser.gps.pgsd4java.types.DevicesObject;
import net.it_adviser.gps.pgsd4java.types.ENMEAMode;
import net.it_adviser.gps.pgsd4java.types.EParity;
import net.it_adviser.gps.pgsd4java.types.GSTObject;
import net.it_adviser.gps.pgsd4java.types.IGPSObject;
import net.it_adviser.gps.pgsd4java.types.ParseException;
import net.it_adviser.gps.pgsd4java.types.PollObject;
import net.it_adviser.gps.pgsd4java.types.SATObject;
import net.it_adviser.gps.pgsd4java.types.SKYObject;
import net.it_adviser.gps.pgsd4java.types.TPVObject;
import net.it_adviser.gps.pgsd4java.types.VersionObject;
import net.it_adviser.gps.pgsd4java.types.WatchObject;
import net.it_adviser.gps.pgsd4java.types.subframes.ALMANACObject;
import net.it_adviser.gps.pgsd4java.types.subframes.EPHEM1Object;
import net.it_adviser.gps.pgsd4java.types.subframes.EPHEM2Object;
import net.it_adviser.gps.pgsd4java.types.subframes.EPHEM3Object;
import net.it_adviser.gps.pgsd4java.types.subframes.ERDObject;
import net.it_adviser.gps.pgsd4java.types.subframes.HEALTH2Object;
import net.it_adviser.gps.pgsd4java.types.subframes.HEALTHObject;
import net.it_adviser.gps.pgsd4java.types.subframes.IONOObject;
import net.it_adviser.gps.pgsd4java.types.subframes.SUBFRAMEObject;
